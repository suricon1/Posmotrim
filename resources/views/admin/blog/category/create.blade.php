...
@section('title', 'Admin | Добавить категорию в блог')
@section('key', 'Admin | Добавить категорию в блог')
@section('desc', 'Admin | Добавить категорию в блог')

@section('header-title', 'Добавить категорию в блог')

@section('content')

    <div class="col">
        {!! Form::open(['route' => 'blog.categorys.store']) !!}
