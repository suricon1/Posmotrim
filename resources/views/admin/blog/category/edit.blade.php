...
@section('title', 'Admin | Редактировать категорию блога')
@section('key', 'Admin | Редактировать категорию блога')
@section('desc', 'Admin | Редактировать категорию блога')

@section('header-title', 'Редактировать категорию блога')

@section('content')

    <div class="col">
        {!! Form::open(['route' => ['blog.categorys.update', $category->id], 'method' => 'patch']) !!}
