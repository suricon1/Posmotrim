...
@section('title', 'Admin | Сформировать предварительный Заказ')
@section('key', 'Admin | Сформировать предварительный Заказ')
@section('desc', 'Admin | Сформировать предварительный Заказ')

@section('header-title', 'Сформировать предварительный Заказ')
                    ...
                    @forelse($order->items as $item)
                        <tr>
                            ...
                            <td class="plantmore-product-quantity">
                                {{Form::open(['route'=>['orders.pre.update.item', $order->id]])}}
                            ...
                            <td class="plantmore-product-remove">
                                {{Form::open(['route'=>['orders.pre.delete.item', $order->id]])}}
                                {{Form::hidden('item_id', $item->id)}}
                        ...
                        <tr>
                            ...
                            <td class="plantmore-product-quantity">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        {{Form::open(['route'=>['orders.pre.add.item', $order->id], 'style' => 'margin: 2px;'])}}
