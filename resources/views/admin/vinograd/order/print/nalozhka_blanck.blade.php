...
@section('title', 'Admin | Заказ № ' . $order->id . '. Печать бланка наложенного платежа')
@section('key', 'Admin | Заказ № ' . $order->id . '. Печать бланка наложенного платежа')
@section('desc', 'Admin | Заказ № ' . $order->id . '. Печать бланка наложенного платежа')

@section('header-title', 'Заказ № ' . $order->id . '. Печать бланка наложенного платежа')
...
<table class="c22">
    ...
    <tr>
        <td class="c13" colspan="1" rowspan="1">
            ...
            <p class="c0 mb-2">
                НАЛОЖЕННЫЙ ПЛАТЕЖ<span class="c1 ml-3"></span>
            </p>
            ...
            <div class="row">
                ...
                <div class="col-3 align-self-end" style="border-bottom: 1px solid;"></div>
            </div>
            <div class="row">
