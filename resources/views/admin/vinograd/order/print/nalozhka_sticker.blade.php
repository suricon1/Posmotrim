...
@section('title', 'Admin | Заказ № ' . $order->id . '. Печать наклейки наложенного платежа')
@section('key', 'Admin | Заказ № ' . $order->id . '. Печать наклейки наложенного платежа')
@section('desc', 'Admin | Заказ № ' . $order->id . '. Печать наклейки наложенного платежа')

@section('header-title', 'Заказ № ' . $order->id . '. Печать наклейки наложенного платежа')
...
@section('content')
    <div class="row p-2" style="width: 71%; background-color: #ffffff; position: relative; margin: 0 auto;">
        ...
        <div class="col-7 pl-5" style="position: relative; z-index: 10;">
            <span class="mr-2">Объявленная ценнность:</span>
            <span class="c12">{{$costFormat}}</span>
            <br>
