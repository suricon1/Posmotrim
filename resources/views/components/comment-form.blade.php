...
{{--{!! Form::open(['url' => $url, 'id' => 'comment-form']) !!}--}}
{!! Form::open(['url' => '?', 'id' => 'comment-form']) !!}

<input type="hidden" name="product_id" value="{{$product_id ?? null}}">
<input type="hidden" name="post_id" value="{{$post_id ?? null}}">
